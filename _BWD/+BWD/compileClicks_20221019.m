...
function compileClicks(dirPath_analysis,dirPath_audio,depName,nfft,nClicksMax,segDur)
    ...
    [fileNames_ctg,filePaths_ctg] = TWD_Common.Utilities.getFileNames(dirPath_metadata,'cTg',true);
    [fileNames_wav,filePaths_wav] = TWD_Common.Utilities.getFileNames(dirPath_audio,'wav',true);
