...
%   by SBP and JS.
%   Last updated Oct. 19, 2022, using MATLAB R2018b
%
%   Description:
            ...
            while ~doNextEvent
                switch state
                    ...
                    case 'viewclicks'
                        ...
                        clickPrompt = sprintf('CLICK PLOTS: enter =%s, d =Change Direction, o =Change Order, r =Reset, v =Change Freq Range, s =Save',clickStepStr);
                        switch caller
                            case 'BWD'
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %** TMP-TESTING
    function SummaryPlotCallback(src, edata)
    % callback function that should execute when summary plot axes is
    % pressed
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        ...
        x = cp(1,1);
        y = cp(1,2);
        within_x = x >= ha4.XLim(1) && x <= ha4.XLim(2);
        within_y = y >= ha4.YLim(1) && y <= ha4.YLim(2);
        if within_x && within_y
            fprintf('CURSOR POSITION = [%.3f, %.3f]\n', x, y)
        end
        
    end
    hf.WindowButtonDownFcn = @SummaryPlotCallback;
    %** END TESTING 
end
