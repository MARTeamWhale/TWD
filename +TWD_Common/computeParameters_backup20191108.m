...
%   Last updated Jul. 30, 2019, using MATLAB R2018b
%
%   Description:
...
%
%   BACKUP VERSION NOTE:
%       created before fixing xNoise nfft issue when xNoise too small
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% DEV NOTES:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    nNonZero = nfft - numel(xClickWin);
    zeroPad = zeros(1,nNonZero);
