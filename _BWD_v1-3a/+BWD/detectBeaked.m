...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    [~, targetNames] = TWD_Common.Utilities.listFiles(dirPath_detCrit, '[folders]', 'Recursive',false);
    ...
    for ii = 1:nTargets
        ...
        [~, fileNamesii] = TWD_Common.Utilities.listFiles(targetPathii, 'xlsx');
        ...
        for jj = 1:nClickDiscrimii
            ...
            clickDiscrimjj = TWD_Common.ClickDiscriminator(clickDiscrimFilePathjj);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for ii = 1:nMat
        ...
        for jj = 1:nTargets
            ...
            for kk = 1:nDiscrimjj
                ...
                isBeakedMatjj(:,kk) = clickDiscrimkk.evalTargetClicks(dataii);
            end
    ...
    for ii = 1:nSeg
        ...
        for jj = 1:nTargets
            ...
            isEventjj = eventDetjj.evalTargetEvent_logical(isBeakedjj,tClickii);
